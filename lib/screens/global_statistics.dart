...
class GlobalStatistics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        buildCard("CONFIRMADO", summary.totalConfirmed, summary.newConfirmed,
            kConfirmedColor),
        buildCard(
            "ACTIVOS",
            ...
            kActiveColor),
        buildCard("RECUPERADOS", summary.totalRecovered, summary.newRecovered,
            kRecoveredColor),
        buildCard(
            "MUERTOS", summary.totalDeaths, summary.newDeaths, kDeathColor),
        Padding(
          padding: EdgeInsets.symmetric(horizontal: 4, vertical: 6),
          child: Text(
            "Datos Actualizados " + timeago.format(summary.date, locale: 'es'),
            style: TextStyle(
              color: Colors.white,
